...
class PengChengMindTrainOneStepWithLossScaleCell(TrainOneStepWithLossScaleCell):
    """
    Encapsulation class of PengChengMind network training.
    ...
    def __init__(self,
                 ...
                 config=None):
        super(PengChengMindTrainOneStepWithLossScaleCell,
...
class PengChengMindTrainPipelineWithLossScaleCell(nn.Cell):
    """
    Encapsulation class of PengChengMind network training.
    ...
    def __init__(self, network, optimizer, config, scale_update_cell=None, enable_global_norm=True):
        super(PengChengMindTrainPipelineWithLossScaleCell, self).__init__(auto_prefix=False)
        self.config = config
        self.network = network
